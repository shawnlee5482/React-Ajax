...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchForm = __webpack_require__(230);
	var SearchResult = __webpack_require__(250);
	...
	var App = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      Router,
	      { history: hashHistory },
	      React.createElement(Route, { path: '/form', component: SearchForm, result: this.onResult }),
	      React.createElement(Route, { path: '/result', component: SearchResult, result: this.state.result })
	    );
	  }
	});
